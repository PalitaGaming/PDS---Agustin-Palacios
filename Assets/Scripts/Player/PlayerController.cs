...
public class PlayerController : MonoBehaviour
{
    ...
    {
        if (jumpClip != null && playerAudio != null)
        {
    ...
    private IEnumerator BlinkEffect()
    {
        ...
        if (IsGrounded || rb.velocity.y < 0.1f) ChangeState(IdleState);
    }

    private void Die()
    {
        rb.velocity = Vector2.zero;
        if (GameManager.GMSharedInstance != null) GameManager.GMSharedInstance.GameOver();
        this.enabled = false;
    }
